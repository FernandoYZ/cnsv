 ...
 * @var Pdo $pdo Instancia de PDO para la conexión a la base de datos.
 * @var Query $query Consulta SQL actual.
 * @var Bindings $bindings Valores para enlazar en la consulta.
 */
class QueryBuilder {
    protected $pdo;
    protected $query;
    ...
    public function __construct() {
        $this->pdo = Database::getInstance()->obtenerConexion();
        $this->query = '';
        $this->bindings = [];
    }
