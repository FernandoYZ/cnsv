<nav class="navbar fixed top-0 left-0 w-full z-10 bg-transparent text-white py-3 transition-colors duration-300" aria-label="Main navigation">
    <div class="container mx-auto px-4 md:px-8 lg:px-16 xl:px-52 flex justify-between items-center">
        ...
        <ul class="hidden md:flex-grow md:flex md:justify-center space-x-6" role="menubar">
            <li role="menuitem"><a href="<?= base_url('/') ?>" class="relative">Inicio</a></li>
            <li role="menuitem"><a href="<?= base_url('/about') ?>" class="relative">¿Quiénes somos?</a></li>
            <li role="menuitem"><a href="<?= base_url('/visit') ?>" class="relative">Visítanos</a></li>
            <li role="menuitem"><a href="<?= base_url('/donation') ?>" class="relative">Donaciones</a></li>
        </ul>
